...
void handleCaptivePortal() {
  server.send(200, "text/html",
    "<!DOCTYPE html><html>"
    "<head><meta http-equiv='refresh' content='0;url=http://192.168.4.1/'/></head>"
    "<body><p>Redirecting to Aether Portal...</p></body></html>");
}



// --- ÚNICA función setupWiFiAP() ---
void setupWiFiAP() {
