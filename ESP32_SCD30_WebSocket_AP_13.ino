...
// Bitmap de 128x64 pixels para pantalla de inicio
...
// Función para dibujar 2 medidores en una pantalla
...
void handleRoot() {
  // USAR HTML AQUÍ
  server.send(200, "text/html", "<h1>SCD30 Logger - HTML not included</h1>");
}
...
void loop() {
  ...
  // Detectar presión prolongada (3 segundos) para cambiar entre pantallas de gauges
