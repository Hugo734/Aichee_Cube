...
const unsigned char splash_bitmap[] PROGMEM = {
	...
	, 
...
// ===== SISTEMA DE PANTALLAS (MODIFICADO) =====
enum OledScreen {
  SCREEN_SPLASH,      // Nueva pantalla de inicio
  SCREEN_MAIN,
  SCREEN_MODE_MANUAL,
  SCREEN_MODE_AUTO
};

OledScreen oledScreen = SCREEN_SPLASH; // Iniciar en splash screen
...
// Nueva variable para controlar el estado del logging
...
void handleStats() {
  ...
  doc["uptime"] = (millis() - systemStartTime) / 1000; // Tiempo desde último clear
...
// Handler mejorado para limpiar datos
void handleClearData() {
  // Limpiar el vector de datos
  dataLog.clear();
  
  // IMPORTANTE: Resetear el tiempo de inicio del sistema
  systemStartTime = millis();
  
  // Resetear el tiempo del último log
  lastDataLog = millis();
  
  // Establecer bandera para indicar que se limpiaron los datos
  dataClearedFlag = true;
  
  // Deshabilitar temporalmente el logging para evitar que se agreguen datos inmediatamente
...
// Nuevo handler para iniciar/detener el logging
void handleToggleLogging() {
  loggingEnabled = !loggingEnabled;
  
  if (loggingEnabled && dataClearedFlag) {
    // Si se está reiniciando después de un clear, resetear el tiempo
    systemStartTime = millis();
    lastDataLog = millis();
...
// Nuevo handler para iniciar logging (usado por Refresh Stats)
...
<body>
  ...
  <script>
    (function(){
      ...
      setInterval(refreshStats, 2000); // Actualizar más frecuentemente
    })();
  </script>
</body>
</html>
...
void updateOLED() {
  ...
  switch (oledScreen) {
    ...
    case SCREEN_MODE_MANUAL:
      ...
      display.print("CO2: "); display.print(lastCO2, 0); display.println(" ppm");
      display.print("T: ");   display.print(lastTemp, 1); display.println(" C");
      display.print("H: ");   display.print(lastHum, 1); display.println(" %");
      display.print("PWM: "); display.println(pwmValue);
      display.print("Records: "); display.println(dataLog.size());
      display.print("Log: "); display.println(loggingEnabled ? "ON" : "OFF");
      display.println("Rotate=PWM Press=Exit");
      break;
...
void setup() {
  ...
  // Mostrar la pantalla de inicio inmediatamente después de la inicialización
  oledScreen = SCREEN_SPLASH;
  updateOLED();
}

// ==========================
// Loop optimizado sin delays
// ==========================
void loop() {
  ...
  // Data logging solo si está habilitado Y no estamos en splash
  ...
  if (reading == LOW && lastButtonState == HIGH &&
    ...
    if (oledScreen == SCREEN_SPLASH) {
      // Transición de splash a menú principal
  ...
  // Solo enviar WebSocket data si no estamos en splash
  if (oledScreen != SCREEN_SPLASH && 
